...
<head>
	...
	<title>Segmentos - Cadastro</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well" id="fundo">
					...
					<form:form modelAttribute="segmentModel" action="${contextPath}/thegoodbot/segment" method="post">
						...
						<div class="form-group">
							...
							<form:input type="text" path="nameSegment" id="nameSegment is" class="form-control" maxlength="50" size="50" />
